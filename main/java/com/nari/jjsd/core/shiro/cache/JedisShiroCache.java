package com.nari.jjsd.core.shiro.cache;
...
/**
 * @Description:    缓存获取去manger
 * @Author:         ssrs
 * @CreateDate:     2018/8/6 10:56
 * @UpdateUser:     ssrs
 * @UpdateDate:     2018/8/6 10:56
 * @Version:        1.0
 */
...
public class JedisShiroCache<K, V> implements Cache<K, V> {
     ...
     */
    private static final String REDIS_SHIRO_CACHE = "quella-cache:";
    /**
