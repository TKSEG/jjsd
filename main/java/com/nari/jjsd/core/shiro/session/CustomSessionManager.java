...
import com.nari.jjsd.bo.UserOnlineBo;
...
/**
 * @Description:    用户session手动管理
 * @Author:         ssrs
 * @CreateDate:     2018/8/6 11:11
 * @UpdateUser:     ssrs
 * @UpdateDate:     2018/8/6 11:11
 * @Version:        1.0
 */
...
public class CustomSessionManager {
     ...
     * session status
     */
    public static final String SESSION_STATUS ="quella-online-status";
