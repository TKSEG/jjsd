package com.nari.jjsd.core.freemarker;
 ...
 * @Description:    静态变量
 * @Author:         ssrs
 * @CreateDate:     2018/8/7 22:38
 * @UpdateUser:     ssrs
 * @UpdateDate:     2018/8/7 22:38
 * @Version:        1.0
 */
...
//	static final String DOMAIN_CDN = IConfig.get("domain.cdn");//静态资源域名
    ...
    final static String  EXECUTE_CHANGE_USER = "QUELLA_EXECUTE_CHANGE_USER";
}
