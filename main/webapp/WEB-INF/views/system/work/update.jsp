    ...
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="leve2Score" id="leve2Score" value="${work.leve2Score}" lay-verify="required"
                           placeholder="请输入提交人"
                           autocomplete="off"
                           class="layui-input" type="text">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="leve3Score" id="leve3Score" value="${work.leve3Score}" lay-verify="required"
                           placeholder="请输入提交人"
                           autocomplete="off"
                           class="layui-input" type="text">
                </div>
...
<script>
    layui.use(['form', 'layedit', 'table', 'laydate'], function () {
        ...
        form.on('submit(update)', function (data) {
            $.post("${basePath}/work/update", data.field, function (data) {
                // 获取 session
                if (data.status != 200) {
