...
<div class="kit-doc">
    <form class="layui-form layui-form-pane" action="">
        <input name="id" value="${work.wpId}" hidden="hidden"/>
        <div class="layui-form-item">
            <div class="layui-form-item">
                <label class="layui-form-label">岗位名称</label>
                <div class="layui-input-block">
                    <input name="wpName" id="wpName" value="${work.wpName}" lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="leve1Score" id="leve1Score" value="${work.leve1Score}" lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="leve2Score" id="leve2Score" value="${work.leve2Score}" lay-verify="required" placeholder="请输入提交人"
                           autocomplete="off"
                           class="layui-input" type="text">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="leve3Score" id="leve3Score" value="${work.leve3Score}" lay-verify="required" placeholder="请输入提交人"
                           autocomplete="off"
                           class="layui-input" type="text">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="remarks" id="remarks" value="${work.remarks}" lay-verify="remarks"
...
<script>
    layui.use(['form', 'layedit', 'table', 'laydate'], function () {
        ...
        form.on('submit(add)', function (data) {
            $.post("${basePath}/work/addupdate", data.field, function (data) {
                // 获取 session
                if (data.status != 200) {
