    ...
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="realname" id="realname"  lay-verify="required"
                           placeholder="请输入提交人" autocomplete="off"
                           class="layui-input" type="text">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block layui-input-treeselect">
                    <input type="text" name="rids" id="treeselect1" required
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="teamid" id="teamid"  lay-verify="required" placeholder="请输入提交人"
                           autocomplete="off"
                           class="layui-input" type="text">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="mobilePhone" id="mobilePhone"  lay-verify="phone"
                           placeholder="请输入提交人"
                           autocomplete="off"
                           class="layui-input" type="text">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="email" lay-verify="email" placeholder="请输入任务描述"
                           autocomplete="off"
                           class="layui-input" type="text">
                </div>
            </div>
...
<script>
    layui.use(['form', 'layedit', 'table', 'laydate'], function () {
        ...
        form.on('submit(add)', function (data) {
            $.post("${basePath}/systemuser/add", data.field, function (data) {
                // 获取 session
                if (data.status != 200) {
