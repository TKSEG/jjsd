...
<div class="layui-fluid">
 ...
 <c:if test="${ menu.parentId ==null &&  fn:length(menu.children) > 0}">
                                ...
                                <tr>
                                    ...
                                    <td>${menu.url}</td>
                                    <td>
                                        <c:if test="${menu.systemMenu ==2 }">系统菜单，无法操作</c:if>
                                        <c:if test="${menu.systemMenu ==1 }">
                                            <shiro:hasPermission name="/menu/update">
                                                <button class="layui-btn layui-btn-sm layui-btn-normal"
                                                        onClick="update(this,'${menu.id}')">
                                                    <i class="layui-icon">&#xe642;</i>
                                                    编辑
                                                </button>
                                            </shiro:hasPermission>
                                            <shiro:hasPermission name="/menu/del">
                                                <button class="layui-btn layui-btn-sm layui-btn-danger"
                                                        onClick="del(this,'${menu.id}'),'${menu.permission.id}'">
     ...
     <c:set value="${menu.children}" var="childern1"/>
     <c:forEach items="${childern1}" var="childern">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${menu.systemMenu ==1 }">
                                                <shiro:hasPermission name="/menu/update">
                                                    <button class="layui-btn layui-btn-sm layui-btn-normal"
                                                            onClick="update(this,'${childern.id}')">
                                                        <i class="layui-icon">&#xe642;</i>
                                                        编辑
                                                    </button>
                                                </shiro:hasPermission>
                                                <shiro:hasPermission name="/menu/del">
                                                    <button class="layui-btn layui-btn-sm layui-btn-danger"
                                                            onClick="del(this,'${childern.id}','${childern.permission.id}')">
                                                        <i class="layui-icon">&#xe640;</i>
                                                        删除
                                                    </button>
                                                </shiro:hasPermission>
