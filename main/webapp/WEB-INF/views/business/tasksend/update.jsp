...
<div class="kit-doc">
    <form class="layui-form layui-form-pane" action="">
        <input name="tsId" value="${tasksend.tsId}" />
        <input name="taskId" value="${tasksend.taskId}" />
        <input name="wfId" value="${tasksend.wfId}" />

        <div class="layui-form-item">
            <label class="layui-form-label">任务名称</label>
            <div class="layui-input-block">
                <input name="taskName" value="${tasksend.taskName}" lay-verify="required" placeholder="请输入任务名称"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="bpncId" id="bpncId" lay-verify="required" lay-filter="bpncId">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="planTime" id="planTime" value="${tasksend.planTime}" lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="standard" value="${tasksend.standard}" lay-verify="standard" placeholder="请输入任务描述"
                       autocomplete="off"
                       class="layui-input" type="text">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="bfscore" id="bfscore" value="${tasksend.bfscore}" disabled="" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="dutyuId" value="${tasksend.dutyuId}" lay-verify="required" placeholder="请输入提交人"
...
<script>
    ...
    layui.use(['form', 'layedit', 'table', 'laydate'], function () {
        ...
        form.on('submit(update)', function (data) {
            ...
            $.post("${basePath}/tasksend/update", data.field, function (data) {
