    ...
    <div class="layui-row">
        <div class="layui-col-xs12">
            <div class="layui-card">
                <div class="layui-card-header">任务管理列表</div>
                <!--这里写页面的代码-->
                        ...
                        <div class="layui-form" >
                            <div class="layui-form-item">
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <select name="bftype"  id="bftype1"    lay-verify="required"  >
                                            <option value="">请选择</option>
                                            <c:forEach items="${type}" var="t">
                                                <option value="${t.typecode}" > ${t.typename}</option>
                                            </c:forEach>
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input name="uploadtime"   id="uploadtime1"     placeholder="请输入" autocomplete="off" class="layui-input" type="text">
                                    </div>
                                </div>
                                <div class="layui-inline">
                                    <label class="layui-form-label">负责人</label>
                                    <div class="layui-input-inline">
                                        <input  id="bfname2"    placeholder="请输入角色名称" autocomplete="off" class="layui-input" type="text">
                                    </div>
                                </div>
