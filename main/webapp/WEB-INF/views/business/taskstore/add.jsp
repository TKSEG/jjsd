    ...
    <form class="layui-form layui-form-pane" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="taskName"  lay-verify="required" placeholder="请输入任务名称" autocomplete="off" class="layui-input" type="text">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="createdbyName"  lay-verify="required" placeholder="请输入提交人" autocomplete="off" class="layui-input" type="text">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">任务描述:</label>
            <div class="layui-input-block">
                <input name="remarks"  lay-verify="required" placeholder="请输入任务描述" autocomplete="off" class="layui-input" type="text">
            </div>
        </div>
...
<script>
    layui.use(['form', 'layedit', 'table', 'laydate'], function () {
        ...
        form.on('submit(add)', function (data) {
            $.post("${basePath}/taskstore/add", data.field, function (data) {
                // 获取 session
                if (data.status != 200) {
