...
<div class="kit-doc">
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="type" lay-verify="required" placeholder="请输入角色类型" autocomplete="off" class="layui-input"
                       type="text">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layui-input-treeselect">
                <input type="text" name="pids" id="treeselect1" required lay-verify="required" autocomplete="off"
                       placeholder="请选择权限"
                       class="layui-input">
            </div>
        </div>
